...
const ResultCard = ({ result }) => {
  ...
  // Stamp colors based on prediction
    ...
    <div className="relative p-8 bg-[#fdfaf5] border-2 border-gray-300 shadow-[4px_6px_20px_rgba(0,0,0,0.6)] transform -rotate-1 mt-6">
      ...
      <div className="mb-8">
        ...
        <div className="w-full bg-gray-300 h-6 mt-2 border border-vintage-ink relative overflow-hidden">
           {/* Updated progress bar with absolute positioning and an animation */}
           <div 
        ...
        {!isReported ? (
           <div className="flex flex-col md:flex-row justify-between items-center gap-4">
             ...
             <button 
               ...
               className="text-xs uppercase tracking-widest font-bold border-2 border-vintage-ink px-4 py-2 hover:bg-vintage-ink hover:text-vintage-paper transition-colors"
             >
